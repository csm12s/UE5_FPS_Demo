...
void AShooterCharacter::UpdatePawnMeshes()
{
	...
	if (CurrentWeapon)
	{
		CurrentWeapon->UpdateMesh(bFirstPerson);
	}
}
...
void AShooterCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("SwitchView", IE_Pressed, this, &AShooterCharacter::OnSwitchView);
...
void AShooterCharacter::OnSwitchView()
{
...
bool AShooterCharacter::IsThirdPerson() const
{
	return IsAlive() && Controller && Controller->IsLocalPlayerController() 
		&& !bUseFirstPerson;
}
